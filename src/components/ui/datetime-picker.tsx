...
const timePickerInputBase =
  "p-1 inline tabular-nums h-fit border-none outline-none select-none content-box caret-transparent rounded-sm min-w-8 text-center focus:bg-foreground/20 focus-visible:ring-0 focus-visible:outline-none text-white bg-navy";
    ...
    return (
      <div
        className={cn(
          ...
          className,
          "border-white/10 rounded-md gap-1 selection:bg-transparent selection:text-white bg-navy",
        )}
