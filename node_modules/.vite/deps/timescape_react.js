...
// node_modules/timescape/dist/chunk-L3U7FLDR.js
...
var getValue_fn;
var _wrapDateAround;
var wrapDateAround_fn;
var _clearIntermediateState;
var clearIntermediateState_fn;
var _handleKeyDown;
...
var _handleBlur;
var handleBlur_fn;
var _sortRegistryByElements;
var sortRegistryByElements_fn;
var _syncAllElements;
var syncAllElements_fn;
var _syncElement;
var syncElement_fn;
var _createListeners;
var createListeners_fn;
var _setValidatedDate;
var setValidatedDate_fn;
var _focusNextField;
var focusNextField_fn;
var TimescapeManager = class {
  constructor(initialDate, options) {
    ...
    __privateAdd(this, _resizeObserver, new ResizeObserver((entries) => {
      entries.forEach((entry) => {
        var _a, _b;
        const inputElement = (_a = [...__privateGet(this, _registry).values()].find(
          ({ shadowElement }) => shadowElement === entry.target
        )) == null ? void 0 : _a.inputElement;
        if (!inputElement || !((_b = entry.contentBoxSize[0]) == null ? void 0 : _b.inlineSize))
          return;
    ...
    __privateAdd(this, _mutationObserver, new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        ...
        if (((_a = mutation.removedNodes) == null ? void 0 : _a[0]) instanceof HTMLInputElement) {
    ...
    __privateSet(this, _timestamp, initialDate == null ? void 0 : initialDate.getTime());
    if (options) {
  ...
  registerElement(element, type, autofocus, domExists = false) {
    ...
    if (!domExists && element === (registryEntry == null ? void 0 : registryEntry.inputElement)) {
      return;
    }
    element.type = "text";
    ...
    let shadowElement;
    if (!domExists || !(registryEntry == null ? void 0 : registryEntry.shadowElement)) {
  ...
  focusField(which = 0) {
    ...
    const type = typeof which === "number" ? (_a = entries.at(which)) == null ? void 0 : _a.type : (_b = entries.find(({ type: type2 }) => type2 === which)) == null ? void 0 : _b.type;
    type && ((_c = __privateGet(this, _registry).get(type)) == null ? void 0 : _c.inputElement.focus());
  }
};
...
_rootListener = /* @__PURE__ */ new WeakMap();
_cursorPosition = /* @__PURE__ */ new WeakMap();
_resizeObserver = /* @__PURE__ */ new WeakMap();
_mutationObserver = /* @__PURE__ */ new WeakMap();
_copyStyles = /* @__PURE__ */ new WeakMap();
_currentDate = /* @__PURE__ */ new WeakSet();
currentDate_get = function() {
  return __privateGet(this, _timestamp) ? new Date(__privateGet(this, _timestamp)) : /* @__PURE__ */ new Date();
};
_getValue = /* @__PURE__ */ new WeakSet();
getValue_fn = function(type) {
  const registryEntry = __privateGet(this, _registry).get(type);
  const intermediateValue = registryEntry == null ? void 0 : registryEntry.intermediateValue;
...
_wrapDateAround = /* @__PURE__ */ new WeakSet();
...
_clearIntermediateState = /* @__PURE__ */ new WeakSet();
...
_sortRegistryByElements = /* @__PURE__ */ new WeakSet();
...
_syncAllElements = /* @__PURE__ */ new WeakSet();
...
_syncElement = /* @__PURE__ */ new WeakSet();
...
_createListeners = /* @__PURE__ */ new WeakSet();
...
_setValidatedDate = /* @__PURE__ */ new WeakSet();
...
_focusNextField = /* @__PURE__ */ new WeakSet();
focusNextField_fn = function(type, offset = 1, wrap = true) {
  ...
  if (nextIndex)
    (_a = __privateGet(this, _registry).get(nextIndex)) == null ? void 0 : _a.inputElement.focus();
};

// node_modules/timescape/dist/react.js
...
var useTimescape = ({
  ...
  const manager = (0, import_react.useRef)(new TimescapeManager(date));
  const timestamp = date == null ? void 0 : date.getTime();
  const onChangeDateRef = (0, import_react.useRef)(onChangeDate);
  ...
  (0, import_react.useEffect)(() => {
    var _a;
    (_a = manager.current) == null ? void 0 : _a.subscribe((nextDate) => {
      var _a2;
  ...
  return {
    getInputProps: (type, opts) => ({
      ref: (element) => {
        var _a;
        if (element) {
          (_a = manager.current) == null ? void 0 : _a.registerElement(element, type, opts == null ? void 0 : opts.autofocus);
          if (opts == null ? void 0 : opts.ref)
    ...
    getRootProps: () => ({
      ref: (element) => {
        var _a;
        return element && ((_a = manager.current) == null ? void 0 : _a.registerRoot(element));
      }
    })
  };
};
...
//# sourceMappingURL=timescape_react.js.map
